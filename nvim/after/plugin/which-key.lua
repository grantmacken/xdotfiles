...
--[[   ['<leader>gq'] = {'<cmd>Gitsign setqflist<CR>', 'Gitsigns setqflist '}, ]]
--[[   [']h'] = {"&diff ? ']c' : '<cmd>Gitsigns next_hunk<CR>'", 'Next git hunk', expr=true}, ]]
--[[   ['[h'] = {"&diff ? '[c' : '<cmd>Gitsigns prev_hunk<CR>'", 'Previous git hunk', expr=true}, ]]
--[[   -- Help ]]
--[[   ['<leader>h'] = {name='+help'}, ]]
